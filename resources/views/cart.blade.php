                                ...
                                @foreach (Cart::content() as $item)
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-remove">
                                            <a href="{{ route('cart.delete', ['item' => $item->rowId]) }}" class="product-del remove" title="Remove this item">
                                        ...
                                        <td class="product-quantity">
                                            ...
                                            <div class="quantity">
                                                <a href="{{ route('cart.decrement', [ 'item' => $item->rowId, 'qty' => $item->qty ]) }}" class="quantity-minus">-</a>
                                                <input title="Qty" class="email input-text qty text" type="text" placeholder="1" readonly value="{{ $item->qty }}">
                                                <a href="{{ route('cart.increment', [ 'item' => $item->rowId, 'qty' => $item->qty]) }}" class="quantity-plus">+</a>
                                            </div>
